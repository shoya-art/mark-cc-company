...
const LECTURES = [
  // 第0章：今後の進め方
  { id: "0-4", chapter: "第0章", chapter_title: "今後の進め方", title: "ワークの進め方について", type: "info",
    prompt: "このコースでは、動画を見た後にワークに取り組んでいただきます。<br><br>ワークは「正解」を書くものではありません。今のあなたの正直な気持ちを書くことで、自己肯定感を高める練習になります。<br><br>書いた内容はジローが確認して、個別サポートに活かします。<br>誰かに見せるためではなく、自分と向き合うために書いてください。",
    url: null, order: 1 },
  { id: "0-5", chapter: "第0章", chapter_title: "今後の進め方", title: "ジローへの共有方法について", type: "info",
    prompt: "ワークを提出すると、ジローがあなたの回答を確認して個別にサポートします。<br><br>【共有のタイミング】<br>・各ワーク提出後、LINEにて個別フォローを行います<br>・質問や相談がある場合はいつでもLINEへ連絡してください<br><br>【大切なこと】<br>正直に書けば書くほど、サポートの質が上がります。<br>「こんなこと書いていいのかな」と思うことほど、大切なことです。",
    url: null, order: 2 },
